  ...
  theme: {
    extend: {
      ...
      transitionTimingFunction: {
        cato: "cubic-bezier(0.2, 0.8, 0.2, 1)",
      },
      transitionDuration: {
        micro: "180ms",
        macro: "1100ms",
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": {
            boxShadow:
              "0 0 20px hsl(var(--steel-blue) / 0.15), 0 0 60px hsl(var(--steel-blue) / 0.05)",
          },
          "50%": {
            boxShadow:
              "0 0 30px hsl(var(--steel-blue) / 0.25), 0 0 80px hsl(var(--steel-blue) / 0.1)",
          },
        },
        shimmer: {
